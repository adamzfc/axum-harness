...
use auth_service::contracts::service::AuthService;
use auth_service::contracts::service::{AuthError as FeatureAuthError, AuthResult, SessionInfo};
use contracts_auth::UserProfile;
use tauri::AppHandle;
