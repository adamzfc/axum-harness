...
//!
//! Migrated from `servers/indexer/src/sources/`.
...
pub trait EventSource: Send + Sync {
    ...
    async fn pull_events(&self, cursor: Option<&str>) -> Result<Vec<RawEvent>, IndexerError>;
}
...
impl EventSource for MemoryEventSource {
    ...
    async fn pull_events(&self, _cursor: Option<&str>) -> Result<Vec<RawEvent>, IndexerError> {
