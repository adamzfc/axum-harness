...
- [ ] **RUNTIME-01**: core/domain 不依赖任何 host/protocol/chain，业务规则完全隔离
- [ ] **RUNTIME-02**: adapters/hosts/tauri (runtime_tauri) 承载 Tauri command 桥接职责，native host 仅保留 builder/bootstrap
